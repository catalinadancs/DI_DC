                        ...
                        <header>
                            <div class="row">
                                <div class="col">
                                    ...
                                    <img src="{{ public_path('logo/logo.png') }}" alt="Logo Companie" style="max-width: 150px;">
                                ...
                                <div class="col company-details">
                                    ...
                                    <div>Furnizor: Numele Furnizorului</div>
                                    <div>Adresă: Adresa Furnizorului</div>
                                    <div>Contact: Contact Furnizor</div>
                                </div>
                            </div>
                        </header>
                        <main>
